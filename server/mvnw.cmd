...
if exist "%USERPROFILE%\.m2\wrapper\dists\maven-wrapper-3.2.0\maven-wrapper-3.2.0.jar" (
    echo Found %USERPROFILE%\.m2\wrapper\dists\maven-wrapper-3.2.0\maven-wrapper-3.2.0.jar
    goto skipDownload
)
echo Couldn't find %USERPROFILE%\.m2\wrapper\dists\maven-wrapper-3.2.0\maven-wrapper-3.2.0.jar, downloading it ...
...
:skipDownload
if exist "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" goto endDownload
...
if "%ERROR_CODE%"=="0" goto endSaveErrorCode
